...
// composeDoc is a loose model of the Compose YAML we emit. Tests parse-and-
// assert rather than string-match — surviving formatter or key-order changes.
...
func TestGenerate_EmitsClaudeSidecarServiceWithProjectMount(t *testing.T) {
	spec := Spec{
	...
	if err := Generate(spec, &buf); err != nil {
...
func TestGenerate_EmitsSocketProxyAndSharedHomeVolume(t *testing.T) {
	spec := Spec{
		Image:   "img",
...
func TestGenerate_EmitsCredentialsSeedBindMount(t *testing.T) {
	spec := Spec{
		Image:   "img",
...
func TestGenerate_HostNetworkModeChangesNetworkAndDockerHost(t *testing.T) {
	spec := Spec{
		Image:       "img",
		HostNetwork: true,
		Project:     ProjectMount{HostPath: "/host/foo", Name: "foo"},
...
func TestGenerate_EmitsEssentialServiceProperties(t *testing.T) {
	spec := Spec{
		Image:   "img",
		Project: ProjectMount{HostPath: "/host/foo", Name: "foo"},
	}
...
func TestGenerate_BindMountsExtraReposAndAppliesTheirShadows(t *testing.T) {
	spec := Spec{
		Image:   "img",
		Project: ProjectMount{HostPath: "/host/foo", Name: "foo"},
...
func TestGenerate_ShadowsCurrentProjectDirsViaTmpfs(t *testing.T) {
	spec := Spec{
		Image: "img",
		Project: ProjectMount{
			HostPath:    "/host/foo",
...
func TestGenerate_ShadowsCurrentProjectFiles(t *testing.T) {
	spec := Spec{
		Image: "img",
		Project: ProjectMount{
			HostPath:    "/host/foo",
